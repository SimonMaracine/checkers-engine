...
def main(args: list[str]) -> int:
    try:
        ...
        replay_parser.add_argument("match", help="Expression describing the match or match group to be extracted")
        replay_parser.add_argument("--index", help="Expression describing the index of the match from the group", type=int, required=False)
